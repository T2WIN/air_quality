...
CREATE TABLE IF NOT EXISTS `{project_id}.{raw_dataset}.station_metadata` (
...
CREATE TABLE IF NOT EXISTS `{project_id}.{raw_dataset}.station_sensors` (
  station_id              STRING NOT NULL,
  openaq_location_id      INT64 NOT NULL,
...
CREATE TABLE IF NOT EXISTS `{project_id}.{raw_dataset}.openaq_hourly` (
...
CREATE TABLE IF NOT EXISTS `{project_id}.{raw_dataset}.weather_forecasts` (
  station_id              STRING NOT NULL,
  run_id                  STRING NOT NULL,
...
CREATE TABLE IF NOT EXISTS `{project_id}.{raw_dataset}.ingestion_log` (
  run_id                  STRING NOT NULL,
